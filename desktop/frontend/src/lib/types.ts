...
export interface VisionView {
  enabled: boolean;
  model: string; // provider/model ref stored in config
  modelRef?: VisionModelRef | null;
}

export interface ExtendedCapabilitiesView {
  computerEnabled: boolean;
  allowWindowsInputInjection: boolean;
