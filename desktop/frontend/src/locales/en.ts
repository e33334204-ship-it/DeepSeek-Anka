...
export const en = {
  ...
  "settings.vision.title": "Auxiliary vision",
  "settings.vision.hint": "Analyze images with a separate vision-capable model (not your chat model). Required for pasted/attached images on text-only models.",
  ...
  "settings.vision.noImageModels": "No vision model configured yet. Pick a provider below, paste your API key, and save — a vision model will be added automatically.",
  "settings.vision.setupWhenEnabled": "Enable vision above, then configure a vision model provider below.",
  "settings.vision.template": "Vision provider",
  "settings.vision.templateOpenAI": "OpenAI (gpt-4o)",
  "settings.vision.templateOpenAIHint": "Uses https://api.openai.com/v1 — get a key at platform.openai.com",
  "settings.vision.templateDashScope": "Alibaba DashScope (qwen-vl-max)",
  "settings.vision.templateDashScopeHint": "Uses DashScope compatible API — get a key at dashscope.aliyun.com",
  "settings.vision.templateSiliconFlow": "SiliconFlow (Qwen2-VL)",
  "settings.vision.templateSiliconFlowHint": "Uses https://api.siliconflow.cn/v1 — get a key at cloud.siliconflow.cn",
  ...
  "settings.cap.computerTitle": "Computer control",
  "settings.cap.computerHint": "Desktop automation: list apps, screenshot, click, type.",
  "settings.cap.computerEnabled": "Enable computer tool",
  "settings.cap.windowsInput": "Allow keyboard/mouse injection (Windows)",
  "settings.cap.browserTitle": "Browser automation",
  "settings.cap.browserHint": "Headless Chromium for navigate, snapshot, click, screenshot.",
  "settings.cap.browserEnabled": "Enable browser tool",
  "settings.cap.browserHeadless": "Run browser headless (background)",
  "settings.cap.browser": "Browser",
  "settings.cap.computer": "Computer",
  "settings.cap.bridgeTitle": "IM bridge",
  "settings.cap.bridgeHint": "Connect Feishu, WeChat, QQ to reasonix serve.",
  "settings.cap.bridgeEnabled": "Enable bridge",
  "settings.cap.bridgeAddr": "Serve address",
  "settings.cap.bridgeFeishu": "Feishu / Lark config",
  "settings.cap.bridgeWeChat": "WeChat iLink config",
  "settings.cap.bridgeQQ": "QQ Bot config",
  "settings.cap.feishuEnabled": "Enable Feishu",
  "settings.cap.wechatEnabled": "Enable WeChat",
  "settings.cap.qqEnabled": "Enable QQ",
  "settings.cap.configured": "Configured",
  "settings.cap.saveBridge": "Save IM settings",
  "settings.cap.restartBridge": "Restart bridge",
  "settings.cap.bridgeRunning": "Bridge sidecar running",
  "settings.cap.bridgeStopped": "Bridge sidecar stopped",
