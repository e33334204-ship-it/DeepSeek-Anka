...
export const zh: Record<DictKey, string> = {
  ...
  "settings.tab.general": "通用",
	  ...
	  "settings.tab.capabilities": "扩展能力",
  ...
  "settings.vision.noImageModels": "尚未配置视觉模型。请在下方选择服务商、填写 API Key 并保存，系统会自动添加视觉模型。",
  "settings.vision.setupWhenEnabled": "请先勾选「启用视觉辅助」，然后在下方配置视觉模型服务商。",
  "settings.vision.template": "视觉模型服务商",
  "settings.vision.templateOpenAI": "OpenAI（gpt-4o）",
  "settings.vision.templateOpenAIHint": "接口：https://api.openai.com/v1 — 在 platform.openai.com 获取 API Key",
  "settings.vision.templateDashScope": "阿里 DashScope（qwen-vl-max）",
  "settings.vision.templateDashScopeHint": "接口：DashScope 兼容模式 — 在 dashscope.aliyun.com 获取 API Key",
  "settings.vision.templateSiliconFlow": "SiliconFlow（Qwen2-VL）",
  "settings.vision.templateSiliconFlowHint": "接口：https://api.siliconflow.cn/v1 — 在 cloud.siliconflow.cn 获取 API Key",
  ...
  "settings.cap.computerTitle": "电脑操控",
  "settings.cap.computerHint": "桌面自动化：列出应用、截图、点击、输入。",
  "settings.cap.computerEnabled": "启用 computer 工具",
  "settings.cap.windowsInput": "允许键鼠注入（Windows）",
  "settings.cap.browserTitle": "浏览器自动化",
  "settings.cap.browserHint": "无头 Chromium：导航、快照、点击、截图。",
  "settings.cap.browserEnabled": "启用 browser 工具",
  "settings.cap.browserHeadless": "后台无头运行",
  "settings.cap.browser": "浏览器",
  "settings.cap.computer": "电脑",
  "settings.cap.bridgeTitle": "IM 桥接",
  "settings.cap.bridgeHint": "接入飞书、微信、QQ，连接到 reasonix serve。",
  "settings.cap.bridgeEnabled": "启用桥接",
  "settings.cap.bridgeAddr": "Serve 地址",
  "settings.cap.bridgeFeishu": "飞书（Lark）配置",
  "settings.cap.bridgeWeChat": "微信 iLink 配置",
  "settings.cap.bridgeQQ": "QQ 机器人配置",
  "settings.cap.feishuEnabled": "启用飞书",
  "settings.cap.wechatEnabled": "启用微信",
  "settings.cap.qqEnabled": "启用 QQ",
  "settings.cap.configured": "已配置",
  "settings.cap.saveBridge": "保存 IM 配置",
  "settings.cap.restartBridge": "重启桥接",
  "settings.cap.bridgeRunning": "桥接服务运行中",
  "settings.cap.bridgeStopped": "桥接服务未运行",
