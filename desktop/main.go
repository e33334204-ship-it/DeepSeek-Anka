// Command deepseek-anka-desktop is the Wails shell around the DeepSeek-Anka kernel: a native
...
// a nested module (deepseek-anka/desktop) so the CGO/WebKit desktop build never touches
