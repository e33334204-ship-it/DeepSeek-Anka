...
var Chinese = Messages{
	...
	ListHooksNone:       "无生效 hooks — 在 .deepseek-anka/settings.json（项目，需信任后）或 ~/.deepseek-anka/settings.json（全局）配置",
...
配置：
  优先级：flag > ./reasonix.toml > ~/.config/deepseek-anka/config.toml > 内置默认值
