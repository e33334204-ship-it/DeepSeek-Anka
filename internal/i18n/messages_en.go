...
var English = Messages{
	...
	ListHooksNone:       "hooks: none active — configure in .deepseek-anka/settings.json (project, after trust) or ~/.deepseek-anka/settings.json (global)",
...
Configuration:
  Resolution: flag > ./reasonix.toml > ~/.config/deepseek-anka/config.toml > built-in defaults
